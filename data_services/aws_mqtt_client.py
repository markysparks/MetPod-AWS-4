...
class MQTTclient:
    def __init__(self, ):
        """Setup the AWS MQTT client, creating certificate files (for AWS IoT)
    ...
    def publish(self, topic, parameters):
        ...
        if not all(value is None for value in parameters.values(
            ...
            data['trend'] = parameters['trend']
            data['tendency'] = parameters['tendency']
            ...
            data['day_max'] = parameters['maxtemp']
            data['night_min'] = parameters['mintemp']
